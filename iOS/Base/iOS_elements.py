...
#剪辑
home_edit = '//XCUIElementTypeStaticText[@name="剪辑"]'
el_home_edit = '//XCUIElementTypeStaticText[@name="视频剪辑"]'
#拍摄
home_camera = '//XCUIElementTypeStaticText[@name="拍摄"]'
el_home_camera = '//XCUIElementTypeStaticText[@name="高清拍摄"]'

#活动
home_clo = '//XCUIElementTypeButton[@name="vivavideo purchase close n"]'
#草稿
el_home_draft = "//*/XCUIElementTypeOther[2]/*/XCUIElementTypeButton"
el_studio_draft = '//*/XCUIElementTypeCollectionView//*/XCUIElementTypeOther[1]/XCUIElementTypeImage[1]'
btn_listview = "vivavideo tool studio list n"
btn_gridview = "vivavideo tool studio list2 n"
btn_studio_del2 = '(//XCUIElementTypeButton[@name="vivavideo tool my studio delet"])[2]'
btn_studio_del1 = '(//XCUIElementTypeButton[@name="vivavideo tool my studio delet"])[1]'
...
el_sticker_used = "//*/XCUIElementTypeCollectionView/XCUIElementTypeCell[2]/XCUIElementTypeOther/XCUIElementTypeImage"
...
el_filter_download ='(//XCUIElementTypeImage[@name="vivavideo_camera_tool_icon_download_nrm"])[1]'
el_filter_used = '/XCUIElementTypeCollectionView/XCUIElementTypeCell[3]/XCUIElementTypeOther/XCUIElementTypeImage'
...
#配乐
el_mus_download = "(//XCUIElementTypeButton[@name='music select download n'])[1]"
el_mus_title1 = '//*/XCUIElementTypeOther[3]//*/XCUIElementTypeCell[1]/XCUIElementTypeButton'
el_mus_title2 = '//*/XCUIElementTypeOther[2]//*/XCUIElementTypeCell[1]/XCUIElementTypeButton'
el_mus_change = "//*/XCUIElementTypeOther[4]/XCUIElementTypeOther/XCUIElementTypeButton"
...
el_setting_back = 'xiaoying com nav back n'
el_preview_back = "vivavideo playerview fullscree"
btn_back = 'vivavideo gallery back n'
el_cancel = "取消"
el_discard = '丢弃'
el_save = '保存'
el_studio_back = '//XCUIElementTypeButton[@name="xiaoying com nav back n"]'
...
gallery_back = 'vivavideo popup icon cancel nr'
...
#素材中心
btn_manager = '//XCUIElementTypeButton[@name="vivavideo material Management "]'
...
el_theme_use = '//*/XCUIElementTypeCell[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeImage'
...
btn_text_comm = '//XCUIElementTypeButton[@name="xiaoying caption bar text n"]'
btn_text_font = "xiaoying caption bar aa n"
btn_text_color = "xiaoying caption bar font n"
btn_text_set = "xiaoying caption bar set n"

btn_text_cho = "//*/XCUIElementTypeOther[3]/XCUIElementTypeOther[1]/XCUIElementTypeCollectionView[2]/*/XCUIElementTypeOther/XCUIElementTypeImage"
btn_cover_cho = "//*/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeCollectionView[2]/XCUIElementTypeCell[1]/XCUIElementTypeOther/XCUIElementTypeImage"
el_text_added = "//*/XCUIElementTypeOther[1]//*/XCUIElementTypeImage[1]"
btn_flip = 'vivavideo_edit_icon_flip_n'
btn_font_download = '(//XCUIElementTypeImage[@name="vivavideo_camera_tool_icon_sticker_download_nrm"])[1]'
...
des_label = '//*/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeTextView'
...
pub_back = 'vivavideo common back left'


#素材中心
el_banner = '//XCUIElementTypeImage[@name="xiaoying_template_no_banner"]'
